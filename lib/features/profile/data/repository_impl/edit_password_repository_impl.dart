import 'package:act_hub_app/features/profile/data/data_source/edit_password_remote_data_source.dart';
import 'package:act_hub_app/features/profile/data/mapper/edit_password_mapper.dart';
    ...
    if (await _networkInfo.isConnected) {
      ...
      try {
        ...
        try {
          ...
          return Left(
              Failure(ResponseCode.UNKNOWN.value, ManagerStrings.UNKNOWN));
        }
      }
    } else {
      return Left(
